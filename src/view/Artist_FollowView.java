...
public class Artist_FollowView extends JFrame {

	private JPanel contentPane;
	boolean evenClick = false;
	boolean evenClick2 = false;
	private volatile static Artist_FollowView instance = null;
	/**
	 * Launch the application.
	 */
	public static Artist_FollowView getInstance() {
        if (instance == null) {
        	instance = new Artist_FollowView();
        }
		return instance;
	}
	...
	public Artist_FollowView() {
		...
		Refreshbtn.setIcon(new ImageIcon(Artist_FollowView.class.getResource("/images2/reload.png")));
		...
		JButton UploadSongbtn = new JButton("Upload Song");
		UploadSongbtn.setToolTipText("New Album");
		UploadSongbtn.setIcon(new ImageIcon(HomeView.class.getResource("/images2/add-circular-outlined-button (1).png")));
		UploadSongbtn.setHorizontalAlignment(SwingConstants.LEFT);
		UploadSongbtn.setFont(new Font("Tahoma", Font.PLAIN, 14));
		UploadSongbtn.setBounds(0, 426, 186, 88);
		RecentlyPlayedPanel.add(UploadSongbtn);
		...
		lblArtistDetails.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblArtistDetails.setBackground(new Color(254, 254, 250));
		lblArtistDetails.setBounds(184, 82, 377, 55);
		Dashboard.add(lblArtistDetails);
		
		JButton ProfileName_Dashboard = new JButton("Artist Name");
		...
		AddQueuebtn.setIcon(new ImageIcon(Artist_FollowView.class.getResource("/images2/star (1).png")));
		...
		FavePlaylistbtn.setIcon(new ImageIcon(Artist_FollowView.class.getResource("/images2/like.png")));
		...
		Add_SongtoAlbum.setIcon(new ImageIcon(Artist_FollowView.class.getResource("/images2/add-song-interface-symbol.png")));
		...
		AddPic_Album.setIcon(new ImageIcon(Artist_FollowView.class.getResource("/images2/picture (1).png")));
		...
		RemoveSongfromAlbum.setIcon(new ImageIcon(Artist_FollowView.class.getResource("/images2/prohibition (1).png")));
		...
		RemoveAlbum.setIcon(new ImageIcon(Artist_FollowView.class.getResource("/images2/delete.png")));
		...
		AddtoQueue.setIcon(new ImageIcon(Artist_FollowView.class.getResource("/images2/add-to-queue-button (1).png")));
